...
import { Monitor, Server, Star, Wrench, ArrowRight, GraduationCap, Target } from "lucide-react";
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-10 mb-16 items-start">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-extrabold text-gray-900 dark:text-white mb-2 leading-tight">
              About{" "}
          ...
          <motion.div
            ...
            className="lg:w-[280px] shrink-0 rounded-2xl p-6
          ...
          >
            <img
              ...
              className="w-full max-w-500 object-contain"
              style={{
        ...
        <div>
          ...
          >
            <div className="h-px flex-1 max-w-[120px] bg-gray-300 dark:bg-violet-500/25" />
            <span className="text-[11px] text-gray-400 dark:text-gray-500 uppercase tracking-[0.25em] font-semibold">
              What defines me
            </span>
            <div className="h-px flex-1 max-w-[120px] bg-gray-300 dark:bg-violet-500/25" />
          </motion.div>
          ...
          >
            {stats.map(({ icon: Icon, label, desc }) => (
              <div
                key={label}
                className="rounded-2xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#0d0d1a] px-5 py-4 flex items-start gap-3"
              >
